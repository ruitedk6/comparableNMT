...
def preprocess_opts(parser):
    ...
    group.add('--comparable', '-comparable', action="store_true",
             help="""Use comparable training. This requires comparable data to be passed as
              arguments.""")
    group.add('--comp_train_src', '-comp_train_src',
             help="Path to the comparable training source data")
    group.add('--comp_train_tgt', '-comp_train_tgt',
             help="Path to the comparable training target data")
