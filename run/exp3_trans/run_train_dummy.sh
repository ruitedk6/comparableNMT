...
python ~/sge/code/onmt_original/OpenNMT-py/train.py \
       	...
       	-save_model ~/sge/models/exp3_trans/00/model/20190213_exp3_2_dummy \
	-layers 6 \
	-transformer_ff 2048 \
	-heads 8 \
	...
	-comp_log ~/sge/models/exp3_trans/00/logs/20190213_exp3_2_dummy
#	&> ~/sge/models/exp3_trans/00/logs/20190213_exp3_2_dummy.log
