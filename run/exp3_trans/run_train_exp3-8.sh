...
python ~/sge/code/onmt_original/OpenNMT-py/train.py \
       	...
       	-save_model ~/sge/models/exp3_trans/08/model/20190301_exp3_8 \
	-layers 6 \
	-transformer_ff 2048 \
	-heads 8 \
	...
	-comp_log ~/sge/models/exp3_trans/08/logs/20190301_exp3_8 \
	-world_size 1 \
	-gpu_ranks 0 \
	&> ~/sge/models/exp3_trans/08/logs/20190301_exp3_8.log
