...
python ~/sge/code/onmt_original/OpenNMT-py/train.py \
       	...
       	-save_model ~/sge/models/exp3_trans/01/model/20190317_exp3_1 \
	-layers 6 \
	-transformer_ff 2048 \
	-heads 8 \
	...
	-comp_log ~/sge/models/exp3_trans/01/logs/20190317_exp3_1 \
	-world_size 1 \
	-gpu_ranks 2 \
	&> ~/sge/models/exp3_trans/01/logs/20190317_exp3_1.log
