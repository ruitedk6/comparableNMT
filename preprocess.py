...
def build_save_vocab(train_dataset, fields, opt, comp_dataset=None):
    fields = inputters.build_vocab(
        train_dataset, fields, opt.data_type, opt.share_vocab,
        opt.src_vocab, opt.src_vocab_size, opt.src_words_min_frequency,
        opt.tgt_vocab, opt.tgt_vocab_size, opt.tgt_words_min_frequency, comp_dataset
    )
...
def main():
    ...
    if opt.comparable:
        comp_dataset_files = build_save_dataset('comp', fields, opt)
    ...
    if opt.comparable:
        build_save_vocab(train_dataset_files, fields, opt, comp_dataset_files)
    else:
